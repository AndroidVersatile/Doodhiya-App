...
//         throw new Error('CLOUDINARY_CLOUD_NAME is undefined. Restart Metro with --reset-cache');
//       }
//       // 1. Prepare Cloudinary Upload
//       const cloudinaryUrl = `https://api.cloudinary.com/v1_1/${CLOUDINARY_CLOUD_NAME}/image/upload`;
//       console.log('Claud URL', cloudinaryUrl);

//       const formData = new FormData();

//       // FIX: Android needs the 'file://' prefix and a proper MIME type
//       // const photo = {
//       //   uri: Platform.OS === 'android' ? image.path : image.path.replace('file://', ''),
//       //   type: 'image/jpeg', // Ensure this matches your file or use image/*
//       //   name: `profile_${uid}.jpg`,
//       // };
//       const photo = {
//         // Try simply image.path without conditional logic first
//         uri: image.path,
...
//         console.log('Cloudinary Error Response:', errorData);
...
//     } catch (error) {
//       // Log the full error to see if it's a network timeout or formatting issue
